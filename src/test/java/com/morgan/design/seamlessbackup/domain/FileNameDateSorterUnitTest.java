...
public class FileNameDateSorterUnitTest {
	...
	// assertThat(Constants.DATE_TIME_FORMAT.parse("16062012091534"),
	// is(new GregorianCalendar(2012, 5, 16, 9, 15, 34).getTime()));
	//
	// // Sun Jun 17 07:24:30 BST 2012
	// assertThat(Constants.DATE_TIME_FORMAT.parse("17062012072430"),
	// is(new GregorianCalendar(2012, 5, 17, 7, 24, 30).getTime()));
	//
	// // Fri Jun 15 09:15:11 BST 2012
	// assertThat(Constants.DATE_TIME_FORMAT.parse("15062012091511"),
	...
	// is("16062012091534-dictionary.json"));
	// }
	//
	// @Test
	...
	// assertThat(entries.get(0).fileName(),
	// is("20062012072430-dictionary.json"));
	// assertThat(entries.get(1).fileName(),
	// is("17062012072430-dictionary.json"));
	// assertThat(entries.get(2).fileName(),
	// is("16062012091534-dictionary.json"));
	// assertThat(entries.get(3).fileName(),
	// is("15062012091511-dictionary.json"));
	// }
	//
//	//@formatter:off
//	//	{
